...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # Initial hidden state is computed from the image features
        ...
        loss, dout = temporal_softmax_loss(tfc_out, captions_out, mask)

        # Backward pass
        dre_out, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dout, tfc_cache)
        ...
        _, grads['W_proj'], grads['b_proj'] = affine_backward(dfc_out, fc_cache)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(max_length):
            ...
            prev_h = next_h # (N, H)
            prev_word = next_word[:, np.newaxis] # Reshape back to (N, 1)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        return captions
